...
parser.add_argument('--batch_size', default=2, type=int, required=False, help='(default=%(default)d)')
...
def save_checkpoint(state, epoch, prefix, filename='.pth.tar'):
    ...
    directory = "models" + args.experiment + '/' + args.approach + '/'
